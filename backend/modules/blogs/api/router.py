...
async def create_article(
    ...
    **Requires:** editor or admin role
    ...
    # Link images to article (TEMPORARILY DISABLED - waiting for migration)
    # try:
...
async def update_article(
    ...
    **Permission:**
    ...
    # Re-sync images if content or cover changed (TEMPORARILY DISABLED - waiting for migration)
